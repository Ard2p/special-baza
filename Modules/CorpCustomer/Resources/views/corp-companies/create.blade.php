            ...
            <div class="col-md-12 user-profile-wrap box-shadow-wrap">
                ...
                <div class="row">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{route('corp-brands.show', $brand->id)}}">{{$brand->full_name}}</a></li>

                        <li class="active">Создать компанию</li>
                    </ol>
                    <form class="proposal-wrap" id="corp_brand_form" action="{{route('corp-companies.store')}}">
                        @csrf
                        <input type="hidden" name="corp_brand_id" value="{{$brand->id}}">
