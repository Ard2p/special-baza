...
class CreateWorkersDrivingLicencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('workers_driving_licences', function (Blueprint $table) {
        ...
        Schema::table('workers_driving_licences', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('workers\_driving_licences');
    }
}
