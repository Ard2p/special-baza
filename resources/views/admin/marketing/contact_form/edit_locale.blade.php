                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" value="{{$localization->name}}">
                        </div>

                        <div class="form-group">
                            <label>Текст лейбла "комменатрии"</label>
                            <input class="form-control" type="text" name="comment_label" value="{{$localization->comment_label}}">
                        </div>
                        <div class="form-group">
                            <label>Текст кнопки</label>
                            <input class="form-control" type="text" name="button_text" value="{{$localization->button_text}}">
                        </div>
                        <div class="form-group">
                            <label>Текст формы</label>
                            <textarea class="form-control" id="html_{{$locale}}" type="text" name="form_text">{{$localization->form_text}}</textarea>
                        </div>
                        ...
                        <div class="form-group form-element-dependentselect">
                            ...
                            <select style="width:100%;" class="form-control input-select"
                                ...
                                @foreach($templates as $template)
                                    <option value="{{$template->id}}" {{$localization->template_id === $template->id ? 'selected' : ''}}>{{$template->name}}</option>
                                @endforeach
                            </select>
                        </div>
                     {{--   <div class="form-group form-element-dependentselect">
