                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="comment_label"
                               value="{{$localization->comment_label}}">
                    </div>
                    <div class="form-group">
                        <label>Текст кнопки</label>
                        <input class="form-control" type="text" name="button_text"
                               value="{{$localization->button_text}}">
                    </div>
                    <div class="form-group">
                        <label>Текст формы</label>
                        <textarea class="form-control" id="html_{{$locale}}" type="text"
                                  name="form_text">{{$localization->form_text}}</textarea>
                    </div>
