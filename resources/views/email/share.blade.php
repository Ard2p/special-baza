                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                    ...
                                    <p style="text-align: center">Ваш друг послал Вам ссылку на страницу:</p>
                                </td>
                            </tr>
                        </table>
                        <!-- // END BODY -->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                    <a class="green-btn"
                                       href="{{$share->url . '?' . http_build_query(['click_id' => $share->id])}}"><strong>О,
                                            как интересно!</strong><br><strong>Открыть
                                            страницу</strong><br>{{ str_replace(['http://', 'https://'], '', $share->url)}}
                                    </a>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                            <tr>
                                <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                    ...
                                    <h6 style="text-align:center;margin-top: 9px;">TRANS-BAZA.ru</h6>
                                </td>
                            </tr>
                        </table>
                    </td>
