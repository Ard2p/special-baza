                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                    ...
                                    <p style="text-align: center">Ваш друг прислал вам ссылку:</p>
                                </td>
                            </tr>
                        </table>
                        <!-- // END BODY -->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                    <a class="green-btn"
                                       href="{{$share->link . '&' . http_build_query(['click_friend_id' => $share->id])}}"><strong>
                                            {{ str_replace(['http://', 'https://'], '', $share->link)}}
                                        </strong>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                    <a class="blue-btn" href="{{$disUrl}}">
                                        <strong>Мне это не нтересно.</strong></a>
                                </td>
                            </tr>
                        </table>
                        <!-- // END BODY -->
