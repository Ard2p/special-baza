    ...
    <style type="text/css">
      ...
      */
        ...
        a.blue-btn {
            ...
            border-bottom: 5px solid #5098ea;
            border-bottom: 5px solid #5098ea;
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                    <h2 style="text-align: center"><strong>Здравствуйте!</strong></h2>
                                    <p style="text-align: center">Я  участник системы, посмотри мою ссылку:</p>
                                </td>
                            </tr>
                        </table>
                        <!-- // END BODY -->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                            <tr>
                                <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                    <a class="green-btn"
                                       href="{{$share->link . '?' . http_build_query(['click_friend_id' => $share->id, 'hash' => $share->hash])}}"><strong>О,
                                            как интересно!</strong><br><strong>Открыть
                                            страницу</strong><br>{{ str_replace(['http://', 'https://'], '', $share->link)}}
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                    <a class="blue-btn" href="{{$disUrl}}">
                                        <strong>Мне это не нтересно.</strong><br><strong>Кто и зачем мне это
                                            прислал?</strong></a>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                            <tr>
                                <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                    ...
                                    <h6 style="text-align:center;margin-top: 9px;">TRANSBAZA.com</h6>
                                </td>
                            </tr>
                        </table>
                    </td>
