...
class SendServiceCenterCreatedToCalendar
{
    ...
    public function handle(ServiceCenterCreatedEvent $event): void
    {
        ...
        $machineryName = $center->note ?? $center->machinery?->name;
        $this->googleService->createEvent(
            ...
            description: "$machineryName. $center->description. Статус: $center->status_name.",
