...
class Share extends Mailable
{
    ...
    public function __construct($subject, ShareList $share)
    {
        $this->share = $share;

        $this->disUrl = route('article_index', ['article' => 'sorry', 'dis_id' => $share->id]);
    ...
    {
        $this->share->pixel_url = route('check_email_pixel', $this->share->id);
        return $this->usingSendersSmtp()->subject($this->subject_message)->view('email.share')
